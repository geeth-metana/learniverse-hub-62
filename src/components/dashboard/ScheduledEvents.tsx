import { CalendarClock, Bell, Maximize2 } from "@/components/icons";

const events = [
  {
    date: "APR 16",
    time: "05:00 PM",
    title: "Frontend vs Backend: Tech Talk",
    subtitle: "Full Stack Web3 Bootcamp - Jordan Lee",
    live: true,
  },
  {
    date: "APR 16",
      ...
      <div className="rounded-2xl border border-border p-2">
        ...
        <div className="divide-y divide-border">
          {events.map((e, i) => (
            <div
              key={i}
              className={`flex items-center gap-3 p-3 ${e.live ? "bg-brand-light/40 rounded-xl" : ""}`}
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  {e.live && (
                    <span className="text-smaller px-1.5 py-0.5 rounded bg-destructive text-destructive-foreground font-bold">
                      Live
                    </span>
                  )}
                </div>
